...
#
# Environment:
#   PROJECT_NAME   lowercase project name (e.g. canpp)
#   WORKSPACE_DIR  absolute path to repo root  (e.g. /workspaces/canpp)
# ---------------------------------------------------------------------------

WORKSPACE_DIR="${WORKSPACE_DIR:-$(git rev-parse --show-toplevel)}"
PROJECT_NAME="${PROJECT_NAME:-canpp}"
CMAKE_PROJECT_NAME="Canpp"
